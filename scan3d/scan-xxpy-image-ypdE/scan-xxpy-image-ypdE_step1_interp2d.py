...
if cam.lower() == 'cam06':
    ...
    #     raise ValueError('Warning: QH05 is turned on according to metadata.')
    # if GL05 != 0.0 and file['config']['metadata']['BTF_MEBT_Mag:PS_QH05:I_Set'][0] == 0.0:
    #     raise ValueError('Warning: QH05 is turned off according to metadata.')
    # if GL06 == 0.0 and file['config']['metadata']['BTF_MEBT_Mag:PS_QV06:I_Set'][0] != 0.0:
    #     raise ValueError('Warning: QH06 is turned on according to metadata.')
    # if GL06 != 0.0 and file['config']['metadata']['BTF_MEBT_Mag:PS_QV06:I_Set'][0] == 0.0:
    #     raise ValueError('Warning: QH06 is turned off according to metadata.')
elif cam.lower() == 'cam34':
    GL05 = 0.0 
    GL06 = 0.0 
    l1 = 0.000 
